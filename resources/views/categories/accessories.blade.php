    ...
    <section class="categories page-section">
        <div class="container">
            <div class="categories__inner">
                <a class="categories__item" href="{{route('Accessories2')}}">
                ...
                <a class="categories__item" href="{{route('clamps')}}">
                    <div class="categories__item-info">
                ...
                <a class="categories__item" href="{{route('rugs')}}">
                    <div class="categories__item-info">
                ...
                <a class="categories__item" href="{{route('mannequins')}}">
                    <div class="categories__item-info">
                ...
                <a class="categories__item" href="{{route('bags')}}">
                    <div class="categories__item-info">
                ...
                <a class="categories__item" href="{{route('decorations')}}">
                    <div class="categories__item-info">
